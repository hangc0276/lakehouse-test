 ...
 */
package io.streamnative.tieredstorage.test;
...
public class Student extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5709700969977801631L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Student\",\"namespace\":\"io.streamnative.tieredstorage.test\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"age\",\"type\":\"int\"},{\"name\":\"payload\",\"type\":\"string\"},{\"name\":\"address\",\"type\":\"string\"},{\"name\":\"number\",\"type\":\"long\"}]}");
   ...
   */
  public Student(java.lang.CharSequence name, java.lang.Integer age, java.lang.CharSequence payload, java.lang.CharSequence address, java.lang.Long number) {
    this.name = name;
    this.age = age;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 4: number = (java.lang.Long)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public static io.streamnative.tieredstorage.test.Student.Builder newBuilder() {
    return new io.streamnative.tieredstorage.test.Student.Builder();
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static io.streamnative.tieredstorage.test.Student.Builder newBuilder(io.streamnative.tieredstorage.test.Student.Builder other) {
    if (other == null) {
      return new io.streamnative.tieredstorage.test.Student.Builder();
    } else {
      return new io.streamnative.tieredstorage.test.Student.Builder(other);
    }
  }
   ...
   * @return A new Student RecordBuilder
   */
  public static io.streamnative.tieredstorage.test.Student.Builder newBuilder(io.streamnative.tieredstorage.test.Student other) {
    if (other == null) {
      return new io.streamnative.tieredstorage.test.Student.Builder();
    } else {
      return new io.streamnative.tieredstorage.test.Student.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Student>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.streamnative.tieredstorage.test.Student.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.streamnative.tieredstorage.test.Student other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.streamnative.tieredstorage.test.Student.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.streamnative.tieredstorage.test.Student.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.streamnative.tieredstorage.test.Student.Builder setAge(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.streamnative.tieredstorage.test.Student.Builder clearAge() {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.streamnative.tieredstorage.test.Student.Builder setPayload(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.streamnative.tieredstorage.test.Student.Builder clearPayload() {
      payload = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.streamnative.tieredstorage.test.Student.Builder setAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.streamnative.tieredstorage.test.Student.Builder clearAddress() {
      address = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.streamnative.tieredstorage.test.Student.Builder setNumber(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.streamnative.tieredstorage.test.Student.Builder clearNumber() {
    ...
    public Student build() {
      try {
        ...
        record.number = fieldSetFlags()[4] ? this.number : (java.lang.Long) defaultValue(fields()[4]);
        return record;
